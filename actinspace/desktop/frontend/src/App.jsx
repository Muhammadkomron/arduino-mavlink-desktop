...
function StandaloneCompass() {
  const [telemetry, setTelemetry] = useState(DEFAULT_TELEMETRY);
  const [theme, setTheme] = useState(() => localStorage.getItem('theme') || 'dark');

  useEffect(() => {
    document.documentElement.setAttribute('data-theme', theme);
    document.title = 'Compass - NazarX';
  }, [theme]);
  ...
  return (
    <div className="standalone-window">
      <Compass heading={telemetry.yaw} magX={telemetry.magX} magY={telemetry.magY} magZ={telemetry.magZ} standalone />
    </div>
  );
}
...
export default function App() {
  ...
  if (viewMode === 'compass') return <StandaloneCompass />;
      ...
      <div className="main-layout">
        ...
        <main className="content">
          ...
          <div className="viz-row">
            ...
            <Compass heading={telemetry.yaw} magX={telemetry.magX} magY={telemetry.magY} magZ={telemetry.magZ} />
          </div>
