...
export default function VideoFeed({ standalone }) {
  ...
  useEffect(() => {
    refreshDevices();
    // Re-scan when a USB device is plugged/unplugged
    ...
    return (
      <div className="standalone-view">
        ...
        <div className="standalone-view-footer">
          ...
          <button className="btn" onClick={refreshDevices} title="Refresh devices" style={{ fontSize: '11px', padding: '4px 8px' }}>⟳</button>
          {!streaming ? (
  ...
  return (
    <div className="viz-card">
      ...
      <div className="video-select">
        ...
        <button className="refresh-ports-btn" onClick={refreshDevices} title="Refresh devices">&#x21BB;</button>
        {!streaming ? (
