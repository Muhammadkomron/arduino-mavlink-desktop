...
/* Global state variables declared extern here; defined in INA219.c */
extern bool isFirst;

extern uint16_t ina219_calibrationValue;
extern float ina219_currentDivider_mA;
...
/* Custom calibration: compute calibration register & LSBs from shunt (ohms) and max expected current (A) */
